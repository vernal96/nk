...
<div class="product<?=$PARAMS["IS_SECTION"] ? " product--section" : "";?>" id="<?= $PARAMS["template"]->GetEditAreaId($PARAMS["ID"]); ?>">
    <a href="<?= $PARAMS["DETAIL_PAGE_URL"] ?: $PARAMS["SECTION_PAGE_URL"]; ?>" class="product__header">
        ...
        ?>
        <img src="<?= CFile::ResizeImageGet($image, Catalog::PRODUCT_IMAGE_SIZE, 3)["src"]; ?>"
